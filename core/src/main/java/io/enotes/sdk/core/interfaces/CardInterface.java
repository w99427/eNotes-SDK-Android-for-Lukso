...
public interface CardInterface {
    ...
    //lukso
    String getPublicKey() throws CommandException;
    int getSignatureCount() throws CommandException;
    boolean challengeBloackChainPrv(String publicKey) throws CommandException;
